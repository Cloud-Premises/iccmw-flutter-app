...
class UpcomingEvents extends StatefulWidget {
  ...
  final GlobalKey<UpcomingEventsState> key;

  const UpcomingEvents({required this.key}) : super(key: key);

  @override
  State<UpcomingEvents> createState() => UpcomingEventsState();
}
...
class UpcomingEventsState extends State<UpcomingEvents> {
  ...
  Future<void> fetchImages() async {
    const url =
        'https://raw.githubusercontent.com/Cloud-Premises/iccmw-app/refs/heads/main/data/assets/json/homePage/upcomingEvents.json';
    try {
