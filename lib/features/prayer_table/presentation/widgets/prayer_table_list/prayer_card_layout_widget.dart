...
import 'package:iccmw/features/prayer_table/presentation/widgets/prayer_table_list/prayer_card_widget.dart';
...
class _PrayerCardLayoutWidgetState extends State<PrayerCardLayoutWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    void prayerTime(prayerDay) {
      FajrStartTime =
          prayersData[month][prayerDay]['Fajr']?['start']?['time'] ?? '--:--';
      dhuhrStartTime =
          prayersData[month][prayerDay]['Dhuhr']?['start']?['time'] ?? '--:--';
      asrStartTime =
          prayersData[month][prayerDay]['Asr']?['start']?['time'] ?? '--:--';
      maghribStartTime = prayersData[month][prayerDay]['Maghrib']?['start']
              ?['time'] ??
          '--:--';
      ishaStartTime =
          prayersData[month][prayerDay]['Isha']?['start']?['time'] ?? '--:--';

      FajrEndTime =
          prayersData[month][prayerDay]['Fajr']?['end']?['time'] ?? '--:--';
      dhuhrEndTime =
          prayersData[month][prayerDay]['Dhuhr']?['end']?['time'] ?? '--:--';
      asrEndTime =
          prayersData[month][prayerDay]['Asr']?['end']?['time'] ?? '--:--';
      maghribEndTime =
          prayersData[month][prayerDay]['Maghrib']?['end']?['time'] ?? '--:--';
      ishaEndTime =
          prayersData[month][prayerDay]['Isha']?['end']?['time'] ?? '--:--';
    ...
    return Container(
      ...
      child: ListView(
        shrinkWrap: true, // Make ListView shrink to fit its content
