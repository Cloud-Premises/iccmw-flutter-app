...
class ServiceDetailPageState extends State<ServiceDetailPage> {
  ...
  void _initializeFormControllers() {
    ...
    final data = serviceData!['data'] as List<dynamic>;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          serviceData != null ? serviceData!['title'] ?? '' : 'Service Detail',
  ...
  List<Widget> _buildServiceDetails() {
    ...
    if (serviceData!['title'] != null && serviceData!['title'].isNotEmpty) {
      widgets.add(Text(
        serviceData!['title'],
